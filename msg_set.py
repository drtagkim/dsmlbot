...
msg_1_2=Message("미래혁신관?","수원대 대운동장 주변에 있는 검은색의 큰 건물입니다.")
...
## 2
msg_2_1=Message("데이터 과학이란?","빅데이터를 분석하여 비즈니스 가치를 발견하는 방법과 이론을 연구하는 학문입니다.")
msg_2_2=Message("이를 위해 갖추고 있는 것은?","DS랩, ML랩, 그리고 Content Creation Studio입니다.")
...
## 5
msg_5_1=Message("C2S Check in/out","Click the link button.",Ext=MessageButton("Form","https://goo.gl/forms/akwagp6ilRzWgAp52"))
msg_5_2=Message("ML Lab permission","Click the link button.",Ext=MessageButton("Form","https://goo.gl/forms/1Fr66NGXvxDzGMhn2"))
## main
...
msg_5=Message("Show me DSML-Forms","Please choose what you want.",toMessages=[msg_5_1,msg_5_2])
#home
